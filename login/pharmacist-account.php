...
extract($_POST);
$id=$_GET['email'];
$sel=mysqli_query($con, "select * from pharmacy where email='$id';");
$detail=mysqli_fetch_assoc($sel);
$ser="";
if (isset($sbt)){
  $ser=$search;
}
$sel1=mysqli_query($con, "select * from prescription where pemail='$ser';");
          ...
          <div class="row">
            <div class="col-sx-12 col-sm-4 col-md-4">
              ...
              <div class="info p-20 bg-black-333">
                <h4 class="text-uppercase text-white"><?= $detail['name'] ?></h4>
                <p class="text-gray-silver"><?= $detail['address'] ?></p>
                <ul class="list angle-double-right m-0">
                  <li class="mt-0 text-gray-silver"><strong class="text-gray-lighter">Email</strong><br> <?= $detail['email'] ?></li>
                  <li class="text-gray-silver"><strong class="text-gray-lighter">Contact</strong><br> <?= $detail['contact'] ?></li>
                </ul>
            ...
            <div class="col-xs-12 col-sm-8 col-md-8">
              <div>
                <form action=<?php echo "\"pharmacist-account.php?email=".$_GET['email']."\""; ?> method="post">
                  <input type="text" name="search" placeholder="Enter patient email-id.">
                  <button type="submit" name="sbt">Search</button>
                </form>
                
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#orders" aria-controls="orders" role="tab" data-toggle="tab" class="font-15 text-uppercase">Prescription <span class="badge"><?php echo $sel1->num_rows; ?></span></a></li>
                  ...
                  <div role="tabpanel" class="tab-pane active" id="orders">
                    <div class="table-responsive">
                      ...
                      <table class="table table-hover">
                         ...
                         <tbody>
                         <?php while($pres=mysqli_fetch_assoc($sel1)){

                          ?>
                            <tr>
                               <th scope="row"><?php echo $pres['id']; ?></th>
                               <td><?php echo $pres['disease']; ?></td>
                               <td><?php echo $pres['demail']; ?></td>
                               
                               <td><a class="btn btn-success btn-xs" href=<?php echo "../prescribe.php?id=".$pres['id']; ?>>View Prescription</a></td>
                            </tr>
                            <?php } ?>
