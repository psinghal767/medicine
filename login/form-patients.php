...
$sel1=mysqli_query($con, "select * from patient where email='$ser';");
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8">
              <div>
                <form action=<?php echo "\"form-patients.php?email=".$_GET['email']."\""; ?> method="post">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-hover">
                         ...
                         <?php while($pres=mysqli_fetch_assoc($sel1)){
                          ...
                          ?>
                            <tr>
                               <th scope="row"><?php echo $pres['name']; ?></th>
                               <td><?php echo $pres['email']; ?></td>
                              
                               
                               <td><a class="btn btn-success btn-xs" href=<?php echo "pres.php?email=".$pres['email']."&dmail=".$id; ?>>Enter Prescription</a></td>
                            </tr>
                            <?php } ?>
